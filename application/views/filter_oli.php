<div class="container-fluid">
        ...
        <div class="carousel-inner">
            ...
            <img src="<?= base_url('assets/img/slide_header.PNG') ?>" class="d-block w-100" src="..." alt="First slide">
            </div>
            <div class="carousel-item">
            <img src="<?= base_url('assets/img/slide_header.PNG') ?>" class="d-block w-100" src="..." alt="Second slide">
            </div>
    ...
    <div class="row text-center mt-4" >
        ...
        <?php foreach ($Filter_Oli as $brg) : ?>

            <div class="card ml-3 mb-3" style="width: 13rem;">
